...
function replaceOnce(path, before, after) {
  const source = read(path); const first = source.indexOf(before);
...
replaceBetween('apps/pdf-worker/src/pdfGenerationService.ts', 'async function approvedInput(', '\n\nasync function savePdf', approved);
console.log('Applied surgical Appwrite adapter/PDF compatibility patches.');
