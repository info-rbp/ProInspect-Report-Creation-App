...
export async function validateSource(context,directory){
  ...
  try{
    ...
    const result={commit:context.commit,validated:true,commands:commands.map(([command,args])=>({command,args}))};atomicJson(resolve(directory,'source-validation.json'),result);return result;
