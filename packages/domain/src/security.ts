...
export const ROLE_CAPABILITIES: Readonly<Record<UserRole, readonly SecurityCapability[]>> = {
  ...
  landlord: ['client.portal.read', 'property.read', 'report.read'],
  shopify_customer: [],
};
...
export interface AuthorisationTarget { agencyId: string; clientAccountId?: string; clientContactId?: string; tenantId?: string; propertyId?: string; tenancyId?: string; inspectionJobId?: string; reportId?: string; maintenanceItemId?: string; maintenanceQuoteId?: string; priceBookId?: string; workRequestId?: string; tenantInstructionId?: string; externalContactId?: string; accessGrantToken?: string; assignedInspectorId?: string; assignedAnalystId?: string; assignedReviewerId?: string; lifecycleStatus?: string; }
