          ...
          {instruction.responseRequired && instruction.status !== 'resolved' && instruction.status !== 'closed' && (
            <form onSubmit={handleSubmit} className="space-y-3 border-t border-gray-100 pt-4">
              ...
              <div className="rounded-lg border border-gray-200 bg-gray-50 p-3">
                <div className="flex items-center gap-2 font-semibold text-gray-700"><ImagePlus size={15} /> Supporting photo evidence</div>
                <p className="mt-1 text-[11px] leading-4 text-gray-500">Optional evidence is verified against its SHA-256 before the authoritative photo ID is attached to your response.</p>
                <input
                  type="file"
                  multiple
              ...
              <button disabled={busy} type="submit" className="w-full rounded-lg bg-gray-900 py-2.5 text-xs font-medium text-white hover:bg-gray-800 disabled:opacity-50">
