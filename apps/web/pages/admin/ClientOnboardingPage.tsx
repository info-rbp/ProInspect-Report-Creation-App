...
const STEPS = [
  'Identity', 'Contacts', 'Engagement & Services', 'Billing', 'Operational Preferences',
...
const ClientOnboardingPage: React.FC = () => {
  ...
  const [form, setForm] = useState({
    ...
    pricingProfile: 'standard', xeroContactId: '', preferredTimeWindow: 'business_hours', minimumBookingNoticeHours: '48',
    ...
    try {
      ...
      const account = await createClientAccount({
        ...
        billingProfile: {
          ...
          xeroContactId: form.xeroContactId.trim() || undefined,
        },
