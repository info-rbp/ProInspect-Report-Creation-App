    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <section className="h-fit rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          {item.status === 'verification_required' && <textarea rows={3} value={verificationNote} onChange={(event) => setVerificationNote(event.target.value)} placeholder="Verification note required..." className="mt-3 w-full rounded-lg border border-gray-300 p-2 text-xs" />}
        </section>
      </div>
