  ...
  return (
    <section className="space-y-5">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div><h1 className="text-2xl font-bold">Inspection Planner</h1><p className="text-sm text-gray-600">Build, optimise and publish inspector routes without changing the inspection evidence workflow.</p></div>
      ...
      {showCreate && (
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/40 p-4" role="dialog" aria-modal="true" aria-labelledby="route-plan-title">
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white p-5 shadow-xl">
            <div className="flex items-start justify-between gap-4"><div><h2 id="route-plan-title" className="text-lg font-bold">Create route plan</h2><p className="text-sm text-gray-500">Nothing is persisted until you select Create plan.</p></div><button type="button" onClick={() => setShowCreate(false)} className="rounded border px-3 py-1.5 text-sm">Cancel</button></div>
