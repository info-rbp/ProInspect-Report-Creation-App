...
const App: React.FC = () => (
  <AuthProvider><BrowserRouter><Routes>
    ...
    <Route path="/app" element={<ProtectedRoute />}><Route element={<AppShell />}><Route index element={<Navigate to="/app/dashboard" replace />} />
      ...
      <Route element={<RoleProtectedRoute section="jobs" />}><Route path="admin/jobs" element={<InspectionJobsPage />} /><Route path="admin/jobs/configuration" element={<InspectionOperationsConfigurationPage />} /><Route path="admin/jobs/:jobId" element={<InspectionJobConsolePage />} /></Route>
      ...
      <Route element={<RoleProtectedRoute section="tenants" />}><Route path="admin/tenants" element={<TenantsPage />} /><Route path="admin/tenants/actions" element={<TenantFollowUpPage />} /><Route path="admin/tenants/:tenantId/portal" element={<TenantPortalAccessPage />} /><Route path="admin/tenants/:tenantId" element={<TenantWorkspacePage />} /><Route path="admin/tenant-followup" element={<Navigate to="/app/admin/tenants/actions" replace />} /></Route>
      ...
      <Route element={<RoleProtectedRoute section="templates" />}><Route path="admin/templates" element={<TemplatesPage />} /></Route><Route element={<RoleProtectedRoute section="settings" />}><Route path="admin/settings" element={<SettingsPage />} /></Route>
