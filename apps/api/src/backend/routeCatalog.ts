...
export const ROUTE_POLICIES: Record<string, RoutePolicy> = {
  ...
  'maintenance-items': { collection: 'maintenanceItems', readCapability: 'maintenance.manage', target },
  'work-requests': { collection: 'workRequests', readCapability: 'maintenance.manage', target },
