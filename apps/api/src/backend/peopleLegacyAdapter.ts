/* Explicit Firebase/Firestore migration fallback. Normal Appwrite operational mode must not call this adapter. */
...
export async function routeFirebasePeopleRequest(req: IncomingMessage, deps: ApiDependencies, correlationId: string): Promise<ApiResponse | undefined> {
