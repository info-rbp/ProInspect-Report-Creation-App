...
import { routeExternalEvidenceCompletionRequest } from './externalEvidenceCompletionRoutes.js';
...
export async function routeSpecialisedCloseoutRequest(
  ...
  return (
    await routeExternalEvidenceCompletionRequest(req, dependencies, correlationId)
