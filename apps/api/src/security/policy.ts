...
const capabilities: Record<UserRole, ReadonlySet<SecurityCapability>> = {
  ...
  inspector: new Set(['property.read', 'tenancy.read', 'job.read', 'job.inspect', 'report.read', 'report.edit', 'upload.create', 'maintenance.manage']),
  analyst: new Set(['property.read', 'tenancy.read', 'job.read', 'report.read', 'report.edit', 'maintenance.manage', 'analysis.create', 'tenant_instruction.manage', 'external_contact.manage', 'client_approval.manage']),
  reviewer: new Set(['property.read', 'tenancy.read', 'job.read', 'report.read', 'report.review', 'audit.read', 'pdf.create', 'maintenance.manage', 'tenant_instruction.manage', 'client_approval.manage']),
